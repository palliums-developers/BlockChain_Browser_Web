...
class Address extends Component {
  ...
  componentWillMount() {
    ...
    //   address: this.props.match.params.address
    // })
    this.props.getBTCMainAddress(
      "mainnet",
      this.props.match.params.address,
      this.state.page
    );
    this.props.getBTCMainAddressTx(
      this.props.match.params.address,
      this.state.page
    );
  ...
  render() {
    ...
    // this.props.BTC_main_address.list && this.countPage(this.props.BTC_main_address.list.total_count);
    BTC_main_address_tx.total_count &&
      this.countPage(BTC_main_address_tx.total_count);
    return (
            ...
            {BTC_main_address ? (
              <div>
                <div className="price">
                  <p>
                    <i>
                      <img src="/img/address@2x.png" alt="1" />
                    </i>
                    ...
                    <div className="abstract">
                      <div className="abstractContent">
                        ...
                        <p>
                          ...
                          <span>
                            {BTC_main_address && BTC_main_address.balance / 1e8}{" "}
                            BTC
                          </span>
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          <span>
                            {BTC_main_address && BTC_main_address.tx_count}
                          </span>
                        </p>
                    ...
                    <div className="deal">
                      <div className="dealContent1">
                        <div className="dealContents">
                          {BTC_main_address_tx.list &&
                            BTC_main_address_tx.list.map((v, i) => {
                              return (
                                <div>
                                  <p onClick={() => this.goToDeal(v.hash)}>
                                    {v.hash}
                                  </p>
                                    ...
                                    <ul>
                                      {
                                        ...
                                        v.inputs.map((v1, i1) => {
                                          return v1.prev_addresses &&
                                            v1.prev_addresses[i1] ? (
                                            <li>
                                              <p
                                                className="addBlue"
                                                onClick={() =>
                                              ...
                                              <p>
                                                {v1.prev_value / 1e8 + " BTC"}
                                              </p>
                                            </li>
                                          ) : (
                                            <li>
                                              <label>Unparsed address</label>
                                              <p className="blo">0 BTC</p>
                                            </li>
                                          );
                                        })
                                      }
                        ...
                        >
                          ...
                          <i className="arrows">
                            {this.state.showPage ? (
                              ...
                              <img src="/img/weibiaoti2备份 2@2x.png" alt="2" />
                            )}
                          </i>
                          {this.state.showPage ? (
                              ...
                              {this.state.pageList.length > 1 &&
                                this.state.pageList.map((v, i) => {
                                  return (
                                    <p
                                      key={i}
                                      onClick={() => this.changePage("jump", v)}
                                    >
                                      {v}
                                    </p>
                                  );
              ...
              <div className="unavailable">
                <img src="/img/编组 12@2x.png" alt="1"></img>
                <p>
